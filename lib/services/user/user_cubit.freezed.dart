...
//   _Unauthenticated<T> unauthenticated<T extends Model>() {
//     return _Unauthenticated<T>();
//   }

//   _Authenticating<T> authenticating<T extends Model>() {
//     return _Authenticating<T>();
//   }

//   _Authenticated<T> authenticated<T extends Model>({required T user}) {
//     return _Authenticated<T>(
//       user: user,
//     );
//   }

//   _AuthenticationFailure<T> authenticationFailed<T extends Model>(
...
// /// @nodoc
// mixin _$UserState<T extends Model> {
//   @optionalTypeArgs
...
// /// @nodoc
// abstract class $UserStateCopyWith<T extends Model, $Res> {
...
// /// @nodoc
// class _$UserStateCopyWithImpl<T extends Model, $Res>
...
// /// @nodoc
// abstract class _$UnauthenticatedCopyWith<T extends Model, $Res> {
...
// /// @nodoc
// class __$UnauthenticatedCopyWithImpl<T extends Model, $Res>
...
// /// @nodoc
// class _$_Unauthenticated<T extends Model> implements _Unauthenticated<T> {
...
// abstract class _Unauthenticated<T extends Model> implements UserState<T> {
//   const factory _Unauthenticated() = _$_Unauthenticated<T>;
// }

// /// @nodoc
// abstract class _$AuthenticatingCopyWith<T extends Model, $Res> {
...
// /// @nodoc
// class __$AuthenticatingCopyWithImpl<T extends Model, $Res>
//     extends _$UserStateCopyWithImpl<T, $Res>
...
// /// @nodoc
// class _$_Authenticating<T extends Model> implements _Authenticating<T> {
...
// abstract class _Authenticating<T extends Model> implements UserState<T> {
//   const factory _Authenticating() = _$_Authenticating<T>;
// }

// /// @nodoc
// abstract class _$AuthenticatedCopyWith<T extends Model, $Res> {
...
// /// @nodoc
// class __$AuthenticatedCopyWithImpl<T extends Model, $Res>
//     extends _$UserStateCopyWithImpl<T, $Res>
...
// /// @nodoc
// class _$_Authenticated<T extends Model> implements _Authenticated<T> {
...
// abstract class _Authenticated<T extends Model> implements UserState<T> {
...
// /// @nodoc
// abstract class _$AuthenticationFailureCopyWith<T extends Model, $Res> {
...
// /// @nodoc
// class __$AuthenticationFailureCopyWithImpl<T extends Model, $Res>
//     extends _$UserStateCopyWithImpl<T, $Res>
...
// /// @nodoc
// class _$_AuthenticationFailure<T extends Model>
//     implements _AuthenticationFailure<T> {
...
// abstract class _AuthenticationFailure<T extends Model> implements UserState<T> {
